...
TEST_CASE("Verilog.Actions.Module_Temp", "[Verilog][Events][Module_Temp]")
{
  ...
  SECTION("Module instantiation")
  {
    SECTION("Basic Functionality")
    {
      ...
      SECTION("_module_description_ + ModuleDescriptionAction")
      {
        SECTION("tb dro example")
        {
          ...
          require_parse<VerilogGrammar::_module_description_,
  ...
  SECTION("sdf annotation from initial_block action")
  {
    ...
    require_parse<VerilogGrammar::initial_block, CommandArrayAction>(
  ...
  SECTION("sdf annotation from module declaration action")
  {
    ...
    require_parse<VerilogGrammar::_module_declaration_,
                  ModuleDeclarationAction>(basic_annotation_example, test);
