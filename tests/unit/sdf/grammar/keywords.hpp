...
// constexpr auto k_cell_type_str_l        = R"(celltype)";
...
// constexpr auto k_cell_type_str_c         = R"(Celltype)";
...
constexpr auto k_cell_type_str_u         = R"(CELLTYPE)";
...
auto constexpr sdf_keywords = 
  std::array{
    ...
    k_ccond_str_u,            // k_ccond_str_c,            k_ccond_str_l,
    k_cell_str_u,             // k_cell_str_c,             k_cell_str_l,
    k_cell_type_str_u,         // k_cell_type_str_c,         k_cell_type_str_l,
    k_cond_str_u,             // k_cond_str_c,             k_cond_str_l,
    k_condelse_str_u,         // k_condelse_str_c,         k_condelse_str_l,
    k_date_str_u,             // k_date_str_c,             k_date_str_l,
    k_delay_str_u,            // k_delay_str_c,            k_delay_str_l,
    k_delayfile_str_u,        // k_delayfile_str_c,        k_delayfile_str_l,
    k_departure_str_u,        // k_departure_str_c,        k_departure_str_l,
    k_design_str_u,           // k_design_str_c,           k_design_str_l,
    k_device_str_u,           // k_device_str_c,           k_device_str_l,
    k_diff_str_u,             // k_diff_str_c,             k_diff_str_l,
    k_divider_str_u,          // k_divider_str_c,          k_divider_str_l,
    k_exception_str_u,        // k_exception_str_c,        k_exception_str_l,
    k_hold_str_u,             // k_hold_str_c,             k_hold_str_l,
    k_increment_str_u,        // k_increment_str_c,        k_increment_str_l,
    k_instance_str_u,         // k_instance_str_c,         k_instance_str_l,
    k_interconnect_str_u,     // k_interconnect_str_c,     k_interconnect_str_l,
    k_iopath_str_u,           // k_iopath_str_c,           k_iopath_str_l,
    k_label_str_u,            // k_label_str_c,            k_label_str_l,
    k_name_str_u,             // k_name_str_c,             k_name_str_l,
    k_netdelay_str_u,         // k_netdelay_str_c,         k_netdelay_str_l,
    k_nochange_str_u,         // k_nochange_str_c,         k_nochange_str_l,
    k_pathconstraint_str_u,   // k_pathconstraint_str_c,   k_pathconstraint_str_l,
    k_pathpulse_str_u,        // k_pathpulse_str_c,        k_pathpulse_str_l,
    k_pathpulsepercent_str_u, // k_pathpulsepercent_str_c, k_pathpulsepercent_str_l,
    k_period_str_u,           // k_period_str_c,           k_period_str_l,
    k_periodconstraint_str_u, // k_periodconstraint_str_c, k_periodconstraint_str_l,
    k_port_str_u,             // k_port_str_c,             k_port_str_l,
    k_process_str_u,          // k_process_str_c,          k_process_str_l,
    k_program_str_u,          // k_program_str_c,          k_program_str_l,
    k_recovery_str_u,         // k_recovery_str_c,         k_recovery_str_l,
    k_recrem_str_u,           // k_recrem_str_c,           k_recrem_str_l,
    k_removal_str_u,          // k_removal_str_c,          k_removal_str_l,
    k_retain_str_u,           // k_retain_str_c,           k_retain_str_l,
    k_scond_str_u,            // k_scond_str_c,            k_scond_str_l,
    k_sdfversion_str_u,       // k_sdfversion_str_c,       k_sdfversion_str_l,
    k_setup_str_u,            // k_setup_str_c,            k_setup_str_l,
    k_setuphold_str_u,        // k_setuphold_str_c,        k_setuphold_str_l,
    k_skew_str_u,             // k_skew_str_c,             k_skew_str_l,
    k_skewconstraint_str_u,   // k_skewconstraint_str_c,   k_skewconstraint_str_l,
    k_slack_str_u,            // k_slack_str_c,            k_slack_str_l,
    k_sum_str_u,              // k_sum_str_c,              k_sum_str_l,
    k_temperature_str_u,      // k_temperature_str_c,      k_temperature_str_l,
    k_timescale_str_u,        // k_timescale_str_c,        k_timescale_str_l,
    k_timingcheck_str_u,      // k_timingcheck_str_c,      k_timingcheck_str_l,
    k_timingenv_str_u,        // k_timingenv_str_c,        k_timingenv_str_l,
    k_vendor_str_u,           // k_vendor_str_c,           k_vendor_str_l,
    k_version_str_u,          // k_version_str_c,          k_version_str_l,
    k_voltage_str_u,          // k_voltage_str_c,          k_voltage_str_l,
    k_waveform_str_u,         // k_waveform_str_c,         k_waveform_str_l,
    k_width_str_u            // k_width_str_c,            k_width_str_l
  };
