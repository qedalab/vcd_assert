...
constexpr auto node_1_str = static_string("CP");
inline const Node node_1{NodeType::unspecified, "CP"};

constexpr auto node_2_str = static_string("D_ENABLE");
inline const Node node_2{NodeType::unspecified, "D_ENABLE"};

constexpr auto node_3_str = static_string("E_ENABLE");
inline const Node node_3{NodeType::unspecified, "E_ENABLE"};

constexpr auto node_4_str = static_string("F_ENABLE");
inline const Node node_4{NodeType::unspecified, "F_ENABLE"};



constexpr auto net_1_str = static_string("CP");
inline const Node net_1{NodeType::net, "CP"};

constexpr auto net_2_str = static_string("D");
inline const Node net_2{NodeType::net, "D"};

constexpr auto net_3_str = static_string("E");
inline const Node net_3{NodeType::net, "E"};

constexpr auto net_4_str = static_string("F");
